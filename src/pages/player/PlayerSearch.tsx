...
export default function PlayerSearch() {
  ...
  const filteredCities = selectedCountry ? CITIES_BY_COUNTRY[selectedCountry as Country] ?? [] : [];
      ...
      <main className="flex-1 pb-24">
        <div className="max-w-md mx-auto px-4 pt-3 pb-2 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <SelectField label="" value={selectedCountry} onChange={handleCountryChange} options={COUNTRIES} placeholder={t('search.allCountries')} labels={countryLabels} />
            <SelectField label="" value={selectedCity} onChange={setSelectedCity} options={filteredCities} placeholder={t('search.allCities')} />
          </div>
        </div>
