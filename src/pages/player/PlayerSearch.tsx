...
export default function PlayerSearch() {
  ...
  const isLoading = tab === 'coaches' ? coachesLoading : schoolsLoading;
  const results = tab === 'coaches' ? coaches : schools;
        ...
        <div className="max-w-md mx-auto px-4 py-4 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={tab === 'coaches' ? 'Search by name...' : 'Search schools...'}
        ...
        <div className="max-w-md mx-auto px-4 py-4">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="font-medium text-foreground">No {tab} found</p>
              ...
              {schools.map((school: any) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      {school.sport && <span className="text-xs text-muted-foreground">{school.sport}</span>}
                      {school.city && (
                        <span className="flex items-center gap-0.5 text-xs text-muted-foreground">
                          <MapPin className="h-2.5 w-2.5" />{school.city}
                        </span>
                      )}
                    </div>
                  </div>
