-- Add country column to profiles and schools
...
-- Backfill: all existing rows with a city are Polish
UPDATE public.profiles SET country = 'Poland' WHERE city IS NOT NULL AND city != '' AND country IS NULL;
UPDATE public.schools SET country = 'Poland' WHERE city IS NOT NULL AND city != '' AND country IS NULL;

-- Update delete_my_account to also clear country
